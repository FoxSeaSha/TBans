...
implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("TBan.commands.tempmute")) {
            sender.sendMessage((Object)ChatColor.RED + "\u0423 \u0432\u0430\u0441 \u043d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u043f\u0440\u0430\u0432.");
            return true;
        }
        if (args.length == 0) {
            sender.sendMessage((Object)ChatColor.YELLOW + "/" + label + " [\u0438\u0433\u0440\u043e\u043a] [\u0432\u0440\u0435\u043c\u044f] [\u043f\u0440\u0438\u0447\u0438\u043d\u0430] - \u041d\u0430\u043b\u043e\u0436\u0438\u0442\u044c \u043c\u0443\u0442 \u043d\u0430 \u0438\u0433\u0440\u043e\u043a\u0430 \u043d\u0430 \u0432\u0440\u0435\u043c\u044f.");
        ...
        if (args.length > 0) {
            ...
            long ct = Utils.checkTime(AccessType.MUTE, sender, time);
            if (ct != -1 && ct * 60 < time) {
            ...
            BanManager.addBan(args[0], BanType.MUTE, sender.getName(), System.currentTimeMillis() + time * 1000, reason);
            if (!silent) {
                Bukkit.broadcastMessage((String)Utils.buildMessage("broadcast_tempmute", new MRep("%player%", args[0]), new MRep("%owner%", sender.getName()), new MRep("%reason%", reason), new MRep("%time%", String.valueOf(t.getRaw()) + " " + t.getUnit())));
            } else {
