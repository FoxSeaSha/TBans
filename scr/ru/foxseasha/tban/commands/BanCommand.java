...
implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("TBan.commands.ban")) {
            sender.sendMessage((Object)ChatColor.RED + "\u0423 \u0432\u0430\u0441 \u043d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u043f\u0440\u0430\u0432.");
            return true;
        }
        if (args.length == 0) {
            sender.sendMessage((Object)ChatColor.YELLOW + "/" + label + " [\u0438\u0433\u0440\u043e\u043a] [\u043f\u0440\u0438\u0447\u0438\u043d\u0430] - \u0417\u0430\u0431\u0430\u043d\u0438\u0442\u044c \u0438\u0433\u0440\u043e\u043a\u0430 \u043d\u0430\u0432\u0441\u0435\u0433\u0434\u0430.");
            return true;
        }
        if (args.length > 0) {
            ...
            BanManager.addBan(args[0], BanType.BAN, sender.getName(), 0, reason);
            if (!silent) {
                Bukkit.broadcastMessage((String)Utils.buildMessage("broadcast_ban", new MRep("%player%", args[0]), new MRep("%owner%", sender.getName()), new MRep("%reason%", reason)));
            } else {
                sender.sendMessage(Utils.buildMessage("broadcast_ban", new MRep("%player%", args[0]), new MRep("%owner%", sender.getName()), new MRep("%reason%", reason)));
            }
            Player pl = Utils.getPlayer(args[0]);
            if (pl != null) {
                pl.kickPlayer(Utils.buildMessage("denymsg_ban", new MRep("%owner%", sender.getName()), new MRep("%reason%", reason)));
            }
            return true;
        }
        return true;
