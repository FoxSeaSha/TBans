...
implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("TBan.commands.unban")) {
        ...
        if (args.length > 0) {
            ...
            if (ban == null || ban != null && ban.getType() != BanType.BAN) {
                sender.sendMessage((Object)ChatColor.RED + "\u041d\u0430 \u0438\u0433\u0440\u043e\u043a\u0430 \u043d\u0435 \u043d\u0430\u043b\u043e\u0436\u0435\u043d \u0431\u0430\u043d.");
                return true;
            }
            BanManager.removeBan(ban.getPlayer());
            if (!silent) {
                Bukkit.broadcastMessage((String)Utils.buildMessage("broadcast_unban", new MRep("%player%", args[0]), new MRep("%owner%", sender.getName())));
            } else {
